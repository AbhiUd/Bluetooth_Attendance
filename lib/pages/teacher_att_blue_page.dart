                ...
                TextButton(
                 ...
                 RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(8.0),
                   ...
                   backgroundColor:const WidgetStatePropertyAll(Color.fromRGBO(217, 217, 217, 1),),
                   ),
                  onPressed: ()
                  {
                 ...
                 Padding(
                  ...
                  Container(
                    ...
                    child: const ColoredBox(color: Color.fromRGBO(188, 185, 185, 1),
                      child: 
                  ...
                  Container(
                    ...
                    child: const ColoredBox(color: Color.fromRGBO(217, 217, 217, 1),
                      // child: 
                      // ScanScreen(),
                    ),
                  ),
                 ...
                 const SizedBox(height: 20,),
                  ...
                  Row(
                    ...
                    children: [
                     Dropdown(dropdownItems: classList,hint: "Class",),
                     Dropdown(dropdownItems: classDIV,hint: "Div",),
                    ],
                   ),
                   const SizedBox(height: 20,),
